...
iniloc <- data.frame(matrix(c(14, 11, 2019, 34.617, -74.017,
                              19, 12, 2019, 25.476, -66.584), nrow = 2, ncol = 5, byrow = T))
...
## read MT tag data
light <- gdata::read.xls('~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls', sheet='Sunrise and Sunset Times', skip=1, header=T)[,1:5]
lightloc <- gdata::read.xls('~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls', sheet='Lat&Long', skip=1, header=T)#[,1:6] # 6 cols
depth <- gdata::read.xls('~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls', sheet='Press Data', skip=1, header=T)[,1:5] # 5 cols
mmd <- gdata::read.xls('~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls', sheet='Press Data (MinMax)', skip=1, header=T)[,1:5] # 5 cols
temp <- gdata::read.xls('~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls', sheet='Temp Data', skip=1, header=T)[,1:5] # 5 cols
temp_max <- gdata::read.xls('~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls', sheet='Temp Data (MinMax)', skip=1, header=T)[,1:5] # 5 cols
...
## LIGHT LOCS
# Get the fish report into a good format
xlsfile = '~/work/Data/Bigeye/WaltTagsAug2020/57508/57508.xls'
...
plot(locs$Date, locs$Longitude)
locs <- locs[which(locs$Longitude < -40 & locs$Longitude > -80),]
...
for (i in 1:length(udates)) get.env(udates[i], filename='mursst', type = 'sst', sst.type='mur', spatLim = sp.lim, save.dir = sst.dir)
...
L.sst <- calc.sst(sst, filename='mursst', sst.dir = sst.dir, dateVec = dateVec, sens.err = 1, focalDim = 3)
