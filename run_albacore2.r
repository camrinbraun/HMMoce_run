...
meta <- meta[which(meta$serial_number == 1090269),]
iniloc <- data.frame(matrix(c(lubridate::day(meta$time_coverage_start),
                              lubridate::month(meta$time_coverage_start),
                              lubridate::year(meta$time_coverage_start),
                              meta$geospatial_lat_start,
                              meta$geospatial_lon_start,
                              lubridate::day(meta$time_coverage_end),
                              lubridate::month(meta$time_coverage_end),
                              lubridate::year(meta$time_coverage_end),
                              meta$geospatial_lat_end,
                              meta$geospatial_lon_end), nrow = 2, ncol = 5, byrow = T))
